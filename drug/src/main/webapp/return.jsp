                                        ...
                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                            <div class="review-content-section">
                                                <div id="dropzone1" class="pro-ad addcoursepro">
                                                    <form action="doR.action" method="post" enctype="multipart/form-data" class="dropzone dropzone-custom needsclick addcourse" id="demo1-upload">
                                                        <div class="row">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                            	<div class="form-group">
                                                                     <input name="pic" class="form-control" type="file" id="pic1"/>
                                                                     <div id="pic2" style="display: none;color: red;">*退货照片不能为空</div>
                                                                </div>
                                                                <div class="form-group">
                                                                    <textarea name="function" id="f1" placeholder="退货原因"></textarea>
                                                                    <div id="f2" style="display: none;color: red;">*退货原因不能为空</div>
                                                                     <button type="submit" class="btn btn-primary waves-effect waves-light" id="sub">提交</button>
                                                                     <button class="btn btn-primary waves-effect waves-light"><a href="findOrder.action"><span style="color: white;">返回上一页</span></a></button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </form>
