									...
									<c:forEach items="${pb.list}" var="o">
										<tr>
											...
											<td><a style="cursor: pointer;"
												href="xiangqing.action?id=${o.did }">详情</a></td>
										</tr>
									</c:forEach>
							...
							<div>
								<ul class="pagination">
									<li class="page-item"><a class="page-link"
										href="tosales.action?pageindex=1">首页</a></li>
									<li class="page-item"><a class="page-link"
										href="tosales.action?pageindex=${pageindex-1 }">上一页</a></li>
									<li class="page-item"><a class="page-link" href="#">${pageindex }</a></li>
									<li class="page-item"><a class="page-link"
										href="tosales.action?pageindex=${pageindex+1 }">下一页</a></li>
									<li class="page-item"><a class="page-link"
										href="tosales.action?pageindex=${count }">尾页</a></li>
								</ul>
							</div>
						</div>
					</div>
